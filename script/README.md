...
|DEPENDABOT_SECURITY_ADVISORIES|**_Optional_**. The advisories for use in checking security related updates. Example: `[{"dependency-name":"name","patched-versions":[],"unaffected-versions":[],"affected-versions":["< 0.10.0"]}]`|
|DEPENDABOT_SECURITY_ADVISORIES_FILE|**_Optional_**. The absolute file path containing security advisories in JSON format similar to `DEPENDABOT_SECURITY_ADVISORIES`. Example: `/mnt/security_advisories/nuget-2022-12-13.json`|
