...
|DEPENDABOT_COMMENT_PULL_REQUESTS|Update vNext|**_Optional_**. Determines whether to comment on pull requests which an explaination of the reason for closing. Defaults to `false`.|
