...
|DEPENDABOT_SECURITY_UPDATES_ONLY|**_Optional_**.|
...
|DEPENDABOT_BRANCH_NAME_PREFIX|**_Optional_**.|
|DEPENDABOT_PR_NAME_PREFIX_STYLE|**_Optional_**.|
...
|DEPENDABOT_MESSAGE_HEADER|**_Optional_**.|
|DEPENDABOT_MESSAGE_FOOTER|**_Optional_**.|
...
|DEPENDABOT_SIGNATURE_KEY|**Optional_**.|
