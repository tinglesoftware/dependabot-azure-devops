...
|DEPENDABOT_REVIEWERS|**_Optional_**. The identifiers of the users to review the pull requests, in JSON format. These will be added as optional approvers. For example: `"[{"id":"be9321e2-f404-4ffa-8d6b-44efddb04865","displayName":"Alice","input":"alice@example.com"}]"`.
|DEPENDABOT_ASSIGNEES|**_Optional_**. The identifiers of the users to be assigned to the pull requests, in JSON format. These will be added as required approvers. For example: `[{"id":"be9321e2-f404-4ffa-8d6b-44efddb04865","displayName":"Alice","input":"alice@example.com"}]`. |
