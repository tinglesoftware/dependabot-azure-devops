...
export class DependabotJobBuilder {
  ...
  constructor({
    ...
    sourceInfo: DependabotSourceInfo;
    ...
    this.source = mapSourceFromDependabotConfigToJobConfig(sourceInfo, update);
    this.credentials = mapCredentials({
      sourceHostname: sourceInfo.hostname,
      systemAccessUser,
      systemAccessToken,
      githubToken,
...
export function mapSourceFromDependabotConfigToJobConfig(
  info: DependabotSourceInfo,
  update: DependabotUpdate,
): DependabotSource {
  return {
    'provider': info.provider,
    'api-endpoint': info['api-endpoint'],
    'hostname': info.hostname,
    'repo': info['repository-slug'],
